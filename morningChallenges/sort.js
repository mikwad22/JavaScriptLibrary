const presidents = [
  ...
  // Challenge: using Array.prototype.sort(), sort the presidents by birth year, oldest to youngest. You will need to implement logic (if) that checks the year each president was born. 
// the sort method is not mutable so it does not create a new array, so it just re-arrages the current array.
