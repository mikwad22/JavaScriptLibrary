    ...
    return (
        <div className="main">
            <div className="mainDiv">
                ...
                <FunctionalComponent string='yes, it will display!'function={toggleBackgroundColor} selectedStyle={backgroundColor}/>
                <FunctionalComponent string='how awesome is that?'function={toggleBorderRadius} selectedStyle={borderRadius}/>
                <FunctionalComponent string='I hope I am doing this right.'function={toggleBorderStyle} selectedStyle={borderStyle}/>
            </div>
        </div>
    </div>  
    );
