 ...
 */
 ...
 /*
    notes on variables: (used for data containers- to store information)
...
/* 
   ...
   Iniitializations are on the RIGHT side of a variable
     -it sets the value of the variable
     -it incorporates the vairable name, the assignment operator, and the value
*/
